...
(function ($) {
    ...
    const sidebarCollapseKey = 'one_db_sidebar_collapsed';
    ...
    (function initSidebarCollapse() {
        ...
        $(document).on('click', '[data-sidebar-collapse]', function () {
            sidebar.classList.toggle('is-collapsed');
            localStorage.setItem(sidebarCollapseKey, sidebar.classList.contains('is-collapsed') ? '1' : '0');
        });
    })();
    ...
    (function initNotificationCenter() {
        ...
        const renderItems = (items) => {
            ...
            if (!items || items.length === 0) {
                ...
                const summary = document.getElementById('notifCount');
                if (summary) {
    ...
    (function initRecentActivity() {
        ...
        fetch('/NotificationCenter/Recent')
            ...
            .then(data => {
                ...
                if (!items.length) {
                    host.innerHTML = '<div class="text-secondary small">Belum ada aktivitas.</div>';
                    return;
                }
                ...
                items.forEach(item => {
                    ...
                    row.className = 'sidebar-activity-item';
                    row.innerHTML = `
                        <span class="sidebar-activity-dot"></span>
                        <div>
                            <div class="fw-semibold">${item.title || 'Aktivitas'}</div>
            ...
            .catch(() => {
                host.innerHTML = '<div class="text-secondary small">Gagal memuat aktivitas.</div>';
            });
    })();
})(jQuery);
